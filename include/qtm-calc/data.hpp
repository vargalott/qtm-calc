...
private:
  /**
   * Perform calculation the final states for a given instance of the queuing system
   *
...
public:
  ...
  /**
   * Perform calculation of the average count of served requests for a given instance
   * of the queuing system and get the result
   *
   * @param[in] qtm Instance of qtm::qtm core class
   */
